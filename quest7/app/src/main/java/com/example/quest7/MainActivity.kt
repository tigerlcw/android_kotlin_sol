...
import com.example.quest7.databinding.ActivityMainBinding
import com.example.quest7.databinding.ItemDialogLayoutBinding
...
class ItemDialog(val clickedItemPos: Int = -1) : BottomSheetDialogFragment(){
    ...
    companion object {
        val names = arrayListOf("김철수", "이영희", "이유리")
    }
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.itemsLiveData.observe(this){
            ...
            //adapter.notifyItemChanged(viewModel.changedItemPos) //특정 아이템 변환에 적용
        }
